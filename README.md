...
Этот же пайплайн крутится в проде и разметил, например, урок
**[«Настройка рабочего места разработчика с Claude Code»](https://neuraldeep.ru/learn/lessons/claude-code-setup)**
(1:34:27 → **64 главы**, **132 хайлайта**, транскрипт, субтитры — всё автоматически):

![Разметка урока: плеер, панель «сейчас в кадре» и главы с таймкодами](examples/assets/lesson-markup.png)

Справа — автоматически сгенерированные **главы с таймкодами и подписями**, панель «сейчас в кадре»
с AI-описанием текущего фрагмента, вкладки Хайлайты / Транскрипт / «Спросить». Всё это — из `timeline.json`.

А в [`examples/timeline.sample.json`](examples/timeline.sample.json) — **реальный вывод** этого
скрипта на коротком демо-ролике (5 сцен с captions/OCR/topic/highlights), чтобы сразу видеть формат.
